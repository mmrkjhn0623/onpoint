...
if($row = mysqli_fetch_array($result)) {
	header("Location: createaccount.php?response=invalid");
}
else{
    if($email != ""){
        $newuser = "INSERT INTO users (username, password, company_id) VALUES ('".$email."','".$pwd."','')";
        $conn->query($newuser);
        ...
        header("Location: createaccount.php?response=success");
    }
    else{
