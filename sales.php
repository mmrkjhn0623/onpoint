...
<html lang="en">
							...
							<div class="form-row">
								<div class="col-md-8">
									<div class="form-group">
										...
										echo "
										<option value=item_".$row["item_id"].">".$row["item_name"]."</option>
										";
	...
	<script>
		function getunitPrice(str){
			...
			xmlhttpprice.open("GET","getunitprice.php?q="+itemid,true);
			xmlhttpprice.send();
			...
			xmlhttpstock.open("GET","getstock.php?q="+itemid,true);
			xmlhttpstock.send();
			}
		...
		function Additem(){
			...
			for (i = 0; i < tr.length; i++) {
				if(document.getElementById("selectitem").value == document.getElementById("ItemTable").rows[i].cells[0].id){
					itemonthelist = 1;	
					itemonthelistrow = i;
				}
			}
