							...
							<div class="card-body">
								...
								<div class="table-responsive">
                                    <table class="table table-bordered" id="ItemTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody id="trow">   
										<?php
											$query = "SELECT invoice.item_id as 'itemid', invoice.si_no as 'sino', invoice.quantity as 'quantity', invoice.quantity * items.unit_price as 'cost', items.item_name as 'item' FROM items,invoice where items.item_id = invoice.item_id and invoice.company_id = '".$_SESSION["companyid"]."' and invoice.si_no = '".$_POST["invoiceno"]."' and invoice.quantity != 0";
