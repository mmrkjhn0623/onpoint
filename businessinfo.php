                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
							...
							if(isset($_SESSION["alert"])){
								if($_SESSION["alert"] == "businessinfoupdate"){
									echo "<div class='alert alert-info alert-dismissible' id='alertdiv'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Business Info Successfully Update!</strong></div>";									
							...
							?>
								...
								<div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Business Info</h3></div>
                                    <div class="card-body">
                                        <form action="updatebusinessinfo.php" method="post" onsubmit="return ValidateNewItem()" style="max-width:620px;margin-inline:auto;">
                                        
                                            <div class="form-group">
                                                <label class="small mb-1" >Business Name</label>
                                                <input class="form-control" id="businessname" name="businessname" type="text" aria-describedby="emailHelp" placeholder="Update Business Name" value="<?php echo $_SESSION["company"];?>" onclick="document.getElementById('alerthere').innerHTML = '';" required/>
                                            </div>
											<div class="form-row">
											<div class="col-md-12">
											<div class="form-group">
                                                <label class="small mb-1" >Address</label>
                                                <input class="form-control" id="address" name="address" type="text" aria-describedby="emailHelp" placeholder="Update Address" value="<?php echo $_SESSION["address"];?>" onclick="document.getElementById('alerthere').innerHTML = '';" required/>
                                            </div>
											</div>
											<div class="col-md-12">
											<div class="form-group">
                                                <label class="small mb-1" >Contact No.</label>
                                                <input class="form-control" id="contact" name="contact" type="number" min="1" aria-describedby="emailHelp" placeholder="Update Contact No." value="<?php echo $_SESSION["contact"];?>" onclick="document.getElementById('alerthere').innerHTML = '';" onkeypress="if(this.value >= 0){return true;}" required/>
                                            </div>
											</div>
											<div class="col-md-12">
											<div class="form-group">
											...
											function ValidateNewItem() {
												...
												var r = confirm("Are You Sure You Want to Update Business Info?");
												if(r == true){
